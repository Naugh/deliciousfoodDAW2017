...
public class DatabaseInitializer {
	...
	public void init() {
		...
		for(int i = 0; i<25;i++){
			...
			Request req4 = new Request("Pedro", "Pizza hut" , "Gutierrez Pacheco", "Avenida de las cañas", "98764523" , "91758945", "28989", 70.0, null);
			r3.getRequests().add(req4);
			requestRepository.save(req4);
	
			Request req5 = new Request("Victor", "Pizza Hut", "Blanco Ruiz", "Calle del puerro Nº 9 Pº 9D", "91153411", "911534331", "28994", 35.0, null);
			r3.getRequests().add(req5);
			requestRepository.save(req5);
	
			Request req6 = new Request("Susana", "Pizza Hut", "Gomez Ruiz", "Calle de las vallas Nº 9 Pº 9D", "92223411", "911534331", "28994", 30.0, null);
		...
		Request req3 = new Request("Teresa", "Dominos" , "Garcia del Hoyo", "Avenida de Belgica Nº 2 Pº IZD", "911112312", "96892111", "28699", 15.0, null);
